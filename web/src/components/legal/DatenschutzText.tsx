// Datenschutzerklärung — verbatim von monoroc.de/datenschutz.html.
// Wrapper-Klassen kommen aus .legalProse in index.css.
// Der Matomo-Opt-out unten lädt das Widget von stats.monoroc.de, sobald es gerendert wird.
  ...
  return (
    <div className="legalProse">
      ...
      <p>
        ...
        Hetzner). Details entnehmen Sie der Datenschutzerklärung von Hetzner:{' '}
        <a
      ...
      <p>
        ...
        des Nutzers (z. B. Device-Fingerprinting) im Sinne des TDDDG umfasst. Die Einwilligung ist
      ...
      <p>
        ...
        Betriebssysteme) und können messen, ob unsere Websitebesucher bestimmte Aktionen durchführen
      ...
      <p>
        ...
        6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TDDDG, soweit die Einwilligung die Speicherung von
      ...
      <p>
        Bei der Analyse mit Matomo setzen wir IP-Anonymisierung ein. Hierbei wird Ihre IP-Adresse
        vor der Analyse gekürzt, sodass Sie Ihnen nicht mehr eindeutig zuordenbar ist.
      </p>

      <h5>Cookielose Analyse</h5>
      ...
      <h5>Widerspruch gegen die Datenerfassung durch Matomo</h5>
      <p>
        Sie können der Erfassung Ihrer Daten durch Matomo jederzeit widersprechen. Aktivieren Sie
        hierzu das folgende Kontrollkästchen. Ihr Widerspruch wird in Ihrem Browser gespeichert und
        gilt für diese Website.
      </p>
      <MatomoOptOut />
...
/** Lädt das Matomo-Opt-out-Widget von stats.monoroc.de, sobald es gerendert wird. */
export function MatomoOptOut() {
  ...
  useEffect(() => {
    ...
    script.src =
      'https://stats.monoroc.de/index.php?module=CoreAdminHome&action=optOutJS&divId=matomo-opt-out&language=auto&showIntro=1'
    script.async = true
    host.appendChild(script)
  }, [])

  return (
    <div className="matomoOptOut" ref={hostRef}>
